...
class HistoryPageState extends State<HistoryPage> {
  List<HistoryModel> histories = [
    HistoryModel('images/ico_send_money.png', 'Paid to', 'Babdya', 500.0,
        '04 April 2020', 'images/ico_logo_red.png'),
    HistoryModel('images/ico_send_money.png', 'Paid to', 'tau', 999.0,
    ...
    HistoryModel('images/ico_receive_money.png', 'Received from', 'kaka', 30.0,
